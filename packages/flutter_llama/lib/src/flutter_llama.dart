...
class FlutterLlama {
  ...
  Stream<String> generateStream(GenerationParams params) async* {
    ...
    try {
      ...
      // Listen to event channel BEFORE invoking — otherwise onListen hasn't
      // fired yet and Kotlin's generateStream will reject with NO_EVENT_SINK.
